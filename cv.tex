...
%% \address{(217) 358-6999 harley-eades@uiowa.edu}
  ...
  \begin{enumerate}
  \item \textbf{Dualized Simple Type Theory.} Harley Eades III, Aaron
  ...
  \item \textbf{Multiple Conclusion Linear Logic: Cut Elimination and
    More}.  Harley Eades III and Valeria de Paiva. In Sergei Artemov
  ...
  \subsection{Workshop Talks}
    ...
    \begin{enumerate}
    \item \textbf{Lambek Calculus.} Harley Eades III and Valeria de
