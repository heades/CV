...
\title{\textbf{XXXXXXCurriculum Vitae\\Harley D. Eades III}\\
  \vspace{10px}
  {\normalsize
  \begin{tabular}{rll}
...
%% \address{(217) 358-6999 harley-eades@uiowa.edu}
  ...
  \begin{itemize}
  \item[] Assistant Professor of Computer Science, August 2014 - Present, Georgia Regents University Augusta.
  \end{itemize}
  ...
  \section{Teaching}
  \textbf{\large{Teaching Assignments at Georgia Regents University (2014 - Present)}}\\
  \ \\
  ...
  \begin{enumerate}
  \item \textbf{Extended Abstract: Reconsidering Intuitionistic Duality}.
  ...
  \begin{enumerate}
  \item \textbf{Full Intuitionistic Linear Logic (FILL).} Harley Eades
  ...
  \subsection{Workshop Talks}
    ...
    \begin{enumerate}
    \item \textbf{Two-sided Linear Sequent Calculus.} Elaine Pimentel and Harley Eades III. Entry in Encyclopedia of Proof Systems. \url{http://proofsystem.github.io/Encyclopedia/}. 2015.

    \item \textbf{Constructive Modal Logic S4 (CS4).} Harley Eades III and Valeria de Paiva. Entry in Encyclopedia of Proof Systems. \url{http://proofsystem.github.io/Encyclopedia/}. 2015.

    \item \textbf{Full Intuitionistic Logic.} Harley Eades III and Valeria de Paiva. Entry in Encyclopedia of Proof Systems. \url{http://proofsystem.github.io/Encyclopedia/}. 2015.
    \end{enumerate}
  ...
  \subsection{Subreviewing}
  \label{subsec:subreviewing}  
  \begin{itemize}
  ...
  \begin{itemize}
  \item[] Internal Advisory Committee for the Cyber Institute, Georgia Regents University, 2014 - Present.
  \end{itemize}
  ...
  \begin{itemize}
  \item[] The Undergraduate Curriculum Committee, Georgia Regents University, 2015 - Present.
    
  \item[] The ABET Assessment Committee, Georgia Regents University, 2015 - Present.
  
  \item[] The Computer Science Curriculum Committee, Georgia Regents University, 2015 - Present.
  \end{itemize}
